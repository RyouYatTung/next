  ...
  return (
    <nav className="flex-between w-full mb-16 pt-3">
      ...
      <div className="sm:hidden flex relative">
        {isUserLoggedIn ? (
          <div className="flex">
            <Image src="/assets/images/logo.svg" width={30} height={30} className="rounded-full" alt="profile" onClick={() => setToggleDropdown((prew) => !prew)} />
            ...
            {toggleDropDown && (
              <div className="dropdown">
                ...
                <Link href="/profile-prompt" className="dropdown_link" onClick={() => setToggleDropdown(false)}>
                  Create Prompt
                </Link>
                <button
                  type="button"
